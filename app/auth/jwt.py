...
def get_password_hash(password: str) -> str:
    ...
    Bcrypt is intentially slow to mitigate attacks against a system and server
    """
...
async def decode_token(token: str,token_type: TokenType,verify_exp: bool = True) -> dict[str, Any]:
    """
